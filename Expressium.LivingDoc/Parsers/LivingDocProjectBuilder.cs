...
{
    internal class LivingDocProjectBuilder
    {
        ...
        public LivingDocProjectBuilder()
        {
        ...
        internal LivingDocProject ConvertToLivingDoc(IEnumerable<Envelope> envelopes)
        {
            var livingDocProject = new LivingDocProject();
            livingDocProject.Title = "Expressium LivingDoc";

            ParseCucumberMessages(envelopes);
        ...
        internal void ParseCucumberMessages(IEnumerable<Envelope> envelopes)
        {
